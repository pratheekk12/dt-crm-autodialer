...
import withPermssionsObj from 'src/components/withPermssionsObj';
    ...
    return loading ? (
      ...
      <Page title="Surveys" className={classes.root}>
        <Container maxWidth={false}>
          {permissions.survey.canAccessSurveyAdminPrivileges && (
            <Box marginBottom={2}>
              <ButtonGroup
                color="primary"
...
export default withPermssionsObj(withStyles(useStyles)(Home));
